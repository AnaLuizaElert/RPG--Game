...
export default function Game(){
  ...
  const choose1 = () => {
    if(cont == 1){
      ...
      finalText = `Peço ajuda ao guarda: Ele logo manda nós dois voltarmos a casa, caso contrário não vamos ganhar sobremesa por um mês. 
      ...
      finalText = `Ele fala que eu preciso voltar para a clínica, eu preciso de tratamento.
      ...
      finalText = `Um moço vem rapidamente em minha direção. 
      ...
      finalText = `Eles acham que eu estou brincando? Por que me olham assim? Quem são esses?
  ...
  const choose2 = () => {
    ...
    finalText = `Duas pessoas atrás de uma mesma árvore não é um bom esconderijo!
    ...
    finalText = `Assim que começo a correr o guarda para de conversar e vêm atrás de mim, ele pede para eu parar, mas não paro. 
    ...
    finalText = `Abro meus olhos e estou em um quarto branco, tem uns aparelhos estranhos, parece que injetam algo na minha veia, quero gritar, mas não consigo. Uma enfermeira chega se identifica e fala
    ...
    finalText = ` Ele fala que eu fui internada para um tratamento.
